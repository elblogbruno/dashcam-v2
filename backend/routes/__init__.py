...
# from .webrtc import router as webrtc_router  # Importar el nuevo router de WebRTC - TEMPORALMENTE DESHABILITADO
...
# router.include_router(webrtc_router, prefix="/api/webrtc", tags=["webrtc"])  # Incluir el router de WebRTC - TEMPORALMENTE DESHABILITADO
